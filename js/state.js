...
const S = {
    data: null, zoom: 1, panX: 0, panY: 0,
    showRooms: true, showSpine: true, showCores: true, showDucts: true, showBalconies: true, showLabels: true, showDims: false, showCirc: false, showGrid: false,
    preset: 'L', dragging: false, lastMouse: { x: 0, y: 0 },
    drawMode: false, customSpine: [], dragIdx: -1, hoverIdx: -1,
    zoningOn: true,
    ...
    snapEnabled: true, orthoEnabled: true, structGridEnabled: true,
    snapRes: 0.25, // metres
    cursorWorld: [0, 0], // live world coords of cursor
    altHeld: false, shiftHeld: false, // modifier keys
    // Unit Mixer Config
    unitMixConfig: [
